                ...
                <div class="section-title fade-in-up">
                 ...
                 <div class="pathways-grid horizontal-scroll-container fade-in-stagger" data-autorotate="true">
                     ...
                     <a href="https://tempusbelgravia.co.uk/treatment_category/facial-aesthetics/" class="pathway-card scale-in">
                         <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/treatments/facial-aesthetics-category.webp" loading="lazy" alt="Facial Aesthetics procedures concept" class="pathway-card-bg">
                     ...
                     <a href="https://tempusbelgravia.co.uk/body-treatment/" class="pathway-card scale-in">
                         <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/treatments/body-contouring-category.webp" loading="lazy" alt="Body Contouring treatments illustration" class="pathway-card-bg">
                         <div class="pathway-card-overlay"></div>
                         <div class="pathway-card-content">
                     ...
                     <a href="https://tempusbelgravia.co.uk/treatment_category/laser-treatments/" class="pathway-card scale-in">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/treatments/laser-energy-category.webp" loading="lazy" alt="Laser and Energy based skin treatments concept" class="pathway-card-bg">
                        <div class="pathway-card-overlay"></div>
                        <div class="pathway-card-content">
                    ...
                    <!-- Pathway Card 4: Injectable Artistry -->
                     <a href="https://tempusbelgravia.co.uk/treatment_category/medical-aesthetics/" class="pathway-card scale-in">
                         <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/treatments/injectable-artistry-category.webp" loading="lazy" alt="Injectable fillers and neuromodulators example" class="pathway-card-bg">
                         <div class="pathway-card-overlay"></div>
                         <div class="pathway-card-content">
                     ...
                     <a href="https://tempusbelgravia.co.uk/treatment_category/dermatology/" class="pathway-card scale-in">
                         <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/treatments/medical-dermatology-category.webp" loading="lazy" alt="Expert medical dermatology consultation" class="pathway-card-bg">
                          <div class="pathway-card-overlay"></div>
                         <div class="pathway-card-content">
                    ...
                    <a href="https://tempusbelgravia.co.uk/treatment_category/iv-infusions/" class="pathway-card scale-in">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/treatments/iv-nutrient-category.webp" loading="lazy" alt="IV nutrient drip therapy session" class="pathway-card-bg">
                         <div class="pathway-card-overlay"></div>
                        <div class="pathway-card-content">
                    ...
                    <a href="https://tempusbelgravia.co.uk/treatment_category/nutrition-and-functional-medicine/" class="pathway-card scale-in">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/treatments/longevity-science-category.webp" loading="lazy" alt="Longevity science integrating nutrition and vitality" class="pathway-card-bg">
                         <div class="pathway-card-overlay"></div>
                        <div class="pathway-card-content">
                     ...
                     <a href="https://tempusbelgravia.co.uk/treatment_category/surgical-services/" class="pathway-card scale-in">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/treatments/surgical-expertise-category.webp" loading="lazy" alt="Refined surgical procedures example" class="pathway-card-bg">
                         <div class="pathway-card-overlay"></div>
                        <div class="pathway-card-content">
